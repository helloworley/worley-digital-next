...
const HalfWidthSnapshotRight = props => {
  ...
  return(  
    <Grid container className={classes.contentContainer}>
      <Grid item xs={12} md={6} className={classes.colContent}>
        ...
        <Grid item xs={12} md={6} className={classes.colImage}>
...
export default HalfWidthSnapshotRight;